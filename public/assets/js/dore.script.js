...
$.dore = function (element, options) {
  ...
  function init() {
    ...
    if (typeof Chart !== "undefined") {
      ...
      if (document.getElementById("salesChart_b2b")) {
        var salesChart = document.getElementById("salesChart_b2b").getContext("2d");
        var myChart = new Chart(salesChart, {
          type: "LineWithShadow",
          options: {
            plugins: {
      ...
      if (document.getElementById("salesChart_all")) {
        var salesChart = document.getElementById("salesChart_all").getContext("2d");
        var myChart = new Chart(salesChart, {
          type: "LineWithShadow",
          options: {
            plugins: {
